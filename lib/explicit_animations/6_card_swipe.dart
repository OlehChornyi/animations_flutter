...
class _CardSwipeDemoState extends State<CardSwipeDemo> {
  ...
  void _resetCards() {
    fileNames = ['assets/hero.jpeg', 'assets/hero.jpeg', 'assets/hero.jpeg'];
  }
                  ...
                  child: Stack(
                    children: [
                      for (var i = 0; i < fileNames.length; i++)
                        Column(
                          children: [
                            SizedBox(height: 8*i.toDouble()),
                            SwipeableCard(
                              imageAssetName: fileNames[i],
                              onSwiped: () {
                                setState(() {
    ...
    return AspectRatio(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          border: Border.all(width: 1, color: Color.fromARGB(255, 191, 8, 8)),
